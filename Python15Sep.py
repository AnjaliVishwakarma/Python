...
"""Instrunction: I guarantee teach Python and you will
understand it only in case you are regular in classes.

'Ek Bhee Lecture Choota then Guarantee Kavach Toota'
"""

"""Indexing/Slicing in Python"""
# s="CETPA"   #index: 0 t0 4
# print(s[0])
# print(s[3])
...
Main Chahe late ho jaayu apko late nahi hona hai.
